            ...
            <Container>
                <div className="p-4 h-screen">
                    ...
                    <Transition visible={visible} animation='scale' duration={500}>
                        ...
                        {
                            this.props.result[0].experiments.map((experiment, index) => {
                                return <ProcessedFiles key={`experiment-${index}`} result={[experiment]} assay={this.props.result[0].assay_technique} bioRepIndex={index + 1}/>
                            })
                        }
                        </ProcessedFilesScaffoldAll>
                        </div>
