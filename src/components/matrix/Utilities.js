...
const aggregators = (tpl => ({
  ...
  // 'Count Pilot' : tpl.countPilot(usFmtInt),
...
*/
  ...
  class FacetData {
    constructor(inputProps = {}) {
      this.props = Object.assign({}, FacetData.defaultProps, inputProps);
      // PropTypes.checkPropTypes(FacetData.propTypes, this.props, 'prop', 'FacetData');
      ...
      FacetData.forEachRecord(this.props.data, this.props.derivedAttributes, record => {
    ...
    //   return FacetData.forEachRecord(this.props.data, this.props.derivedAttributes, record => {
    //     if (!this.filter(record)) {
    //       return;
    //     }
  ...
  FacetData.forEachRecord = function (input, derivedAttributes, f) {
    let addRecord,
      record;
  ...
  FacetData.defaultProps = {
    aggregators: aggregators,
    cols: [],
    rows: [],
    vals: [],
    // aggregatorName: (CONFIG.DATA_PHASE === 'PRODUCTION') ? 'Count Experiments': (CONFIG.DATA_PHASE === 'PILOT') ? 'Count Pilot': null ,
